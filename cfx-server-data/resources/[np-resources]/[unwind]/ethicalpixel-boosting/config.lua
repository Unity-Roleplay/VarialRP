...
Config['CoreSettings'] = {
    ...
    ["QBCORE"] = {
        ...
        ["Trigger"] = "UGCore:GetObject",
        ["HasItem"] = "UGCore:HasItem", -- Imporant [ Your trigger for checking has item, default is CORENAME:HasItem ] 

    }, 
    ["NPBASE"] = {
        ["Name"] = "np-base", -- this will be used in server side to call player module
        ["ProgressBarScriptName"] = "np-taskbar", -- progress bar script name link in np_readme.md
        ["HasItem"] = "np-inventory", -- Imporant [ Your normal export for checking has item, default is yourservername:inventory ] 
...
Config['Utils'] = {
    ["Rewards"] = {
        ...
        ["RewardItemName"] = "rollcash", -- this will be the reward item name (no need to config if you are using an money as a reward)
        ["RewardItemAmount"] = "8", -- reward item count
    ...
    ["Contracts"] = {
        ["TimeBetweenContracts"] = 1800000, -- Time in (ms) between contract creations
        ["ContractChance"] = 60, -- This is the luck percentage of getting a contract
    },
    ["VIN"] = {
        ["BNEPrice"] = 1, -- Price (BNE) for start a vin scratch
