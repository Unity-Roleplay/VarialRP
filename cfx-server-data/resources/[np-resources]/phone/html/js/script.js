...
function drawRaceStats() {
    ...
    $('#OverallTime').text(`Total Time: ${moment(moment.utc() - startTime).format("mm:ss.SSS")}`)
}
    ...
    for (const [ keyType, value ] of Object.entries(keys)) {
        for (const [ data, v ] of Object.entries(value)) {
            ...
            <div class="collapsible-header" style="background-color: #31455E; color: white">
                ...
                <div class="collapsible-body" style="background-color: #31455E;">
                    <div class="row">
                        <div class="col s12">
                            <ul class="collection">`
                            if (keyType === "ownedKeys") {
                                ...
                                if (penis.payments > 1)
                                    keyElement += `<li class="collection-item" style="background-color: #31455E; color: white"><i class="fas fa-credit-card"></i> ${penis.payments} payments left</li>`
                                
                                keyElement += `

                                <li class="collection-item" style="background-color: #31455E; color: white"><i class="fas fa-hourglass-half" ></i> ${penis.payments == 0 ? 'No remaining payments.' : paymentString}</li>
                                <li class="collection-item" style="background-color: #31455E; color: white"><i class="fas fa-money-check-alt"></i> You owe $${Math.floor(penis.amountdue/penis.payments)}</li>
                                `}
                            keyElement += `
                                            </ul>
                                        </div>
