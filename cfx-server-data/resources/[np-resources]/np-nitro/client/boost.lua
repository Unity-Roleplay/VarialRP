...
function SetVehicleNitroBoostEnabled(vehicle, enabled)
  ...
  TriggerEvent("DoLongHudText", "Nitro mode: Boost", 1)
...
Citizen.CreateThread(function ()
  local function BackfireLoop()
    ...
    for vehicle in pairs(vehicles) do
      TriggerServerEvent("nitro:sync:ptfx:backfire", vehicle)
...
RegisterNetEvent("nitro:sync:ptfx:backfire:client")
AddEventHandler("nitro:sync:ptfx:backfire:client", function(pVehicle)
  CreateVehicleExhaustBackfire(pVehicle, 1.25)
end)
