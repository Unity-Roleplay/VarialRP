RegisterNetEvent("showroom-tuner:purchaseVehicle")
AddEventHandler("showroom-tuner:purchaseVehicle", function(model, price, amount)
    local src = source
...
function PurchaseCar(source, vehicle, plate)
    ...
    TriggerClientEvent("showroom-tuner:clPurchaseVehicle", src, model, plate)
end
