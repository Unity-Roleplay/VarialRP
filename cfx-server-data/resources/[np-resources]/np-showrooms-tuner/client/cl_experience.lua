...
RegisterNUICallback("np-ui:tunerapplication-closed", function(data, cb)
...
RegisterNUICallback("np-ui:tunershowroomChangeCar", function(data, cb)
  if vehicle then
    DeleteEntity(vehicle)
  end
...
AddEventHandler("np-showrooms-tuner:enterExperience", function()
  openShowroom("pdm")
