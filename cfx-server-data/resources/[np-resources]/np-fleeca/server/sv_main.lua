...
RegisterNetEvent('np-robbery:smallBankAttempt')
AddEventHandler('np-robbery:smallBankAttempt', function(bId)
    ...
    TriggerClientEvent('np-robbery:updateBankData', -1, banks)
end)

RegisterNetEvent('np-robbery:sBankBox')
AddEventHandler('np-robbery:sBankBox', function(bId, iType)

    banks[bId]['rob'][iType] = true
    TriggerClientEvent('np-robbery:updateBankData', -1, banks)
    TriggerClientEvent('np-robbery:sBankLoot', source)
end)

RegisterNetEvent('np-robbery:PoliceNotifyFleeeee')
AddEventHandler('np-robbery:PoliceNotifyFleeeee', function()

    TriggerClientEvent("np-fleeca:policenotify", -1, bank)
