Citizen.CreateThread(function()
    ...
    exports["np-polyzone"]:AddBoxZone("bennys", vector3(1865.55, 3700.5, 33.37), 13.4, 8, {
      heading=30,
      minZ=32.37,
      maxZ=37.57
    })
    ...
    --pdm preview bennys
    exports["np-polyzone"]:AddBoxZone("bennys", vector3(-33.2, -1053.37, 28.4), 8.0, 9.4, {
      heading=340,
      minZ=25.72,
      maxZ=29.52
    })
  ...
  --    heading = 90,
   ...
   -- })
    ...
    -- hayes
    exports["np-polyzone"]:AddBoxZone("bennys", vector3(-1424.15, -450.01, 35.91), 5, 4, {
      heading=30,
      minZ=35.91-1,
      maxZ=35.91+1
    })
