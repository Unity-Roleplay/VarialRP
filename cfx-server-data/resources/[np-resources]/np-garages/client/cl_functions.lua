...
function SpawnVehicle(vehicle, pGarage, Fuel, customized, plate, IsViewing)
    ...
    if exports['np-menu']:houseGarageCoords() ~= nil and exports['np-menu']:NearHouseGarage() and exports['np-menu']:NearHouseGarage2() then
	...
	Citizen.CreateThread(function()			
        ...
        --RPC.execute("np-wheelfitment_sv:getfuckingdata",veh, plate)
