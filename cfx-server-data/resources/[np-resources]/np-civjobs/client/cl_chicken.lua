...
AddEventHandler("np-civjobs:package-chicken", function(position)
	if exports["np-inventory"]:hasEnoughOfItem("slaughteredchicken", 2) then
		...
		if (finishedpacking ==100 )then 
			...
			TriggerEvent('player:receiveItem', "cbbucket", math.random(1,3))	
...
AddEventHandler("dreams-civjobs:process-alive_chicken", function(position)
	if exports["np-inventory"]:hasEnoughOfItem("livechicken", 1) then
		...
		if (finished == 100) then
			...
			FreezeEntityPosition(GetPlayerPed(-1),false)
			ClearPedTasks(GetPlayerPed(-1))
			TriggerEvent('inventory:removeItem', "livechicken", 1)
			TriggerEvent('player:receiveItem', "slaughteredchicken", math.random(1,6))	
		end
...
function TepnijWyjscie()
	...
	while dajdoAuta do
		...
		if DoesEntityExist(vehicle) then
			...
			ClearPedTasks(GetPlayerPed(-1))
			DeleteEntity(prop)
			TriggerEvent('player:receiveItem', "livechicken", 3)
		end
	end
end
...
AddEventHandler("dreams-chickens:sell", function()
	if exports["np-inventory"]:hasEnoughOfItem("cbbucket",2,false) then 
		...
		if (finished == 100) then
			local chicken = math.random(158, 274)
			TriggerServerEvent('chickenpayment:pay', chicken)
			ClearPedTasksImmediately(PlayerPedId())
			TriggerEvent('inventory:removeItem', "cbbucket", 2)
		end
		DeleteEntity(prop)
	else
...
Citizen.CreateThread(function()
    exports["np-polyzone"]:AddBoxZone("dreams_chicken_procces_station_1", vector3(-95.52, 6207.25, 31.03), 2, 1.8, {
...
AddEventHandler('np-polyzone:enter', function(name)
    if name == "dreams_chicken_procces_station_1" then
		...
		exports['np-ui']:showInteraction("[E] Process Alive Chicken")
    end
end)
...
Citizen.CreateThread(function()
    exports["np-polyzone"]:AddBoxZone("dreams_chicken_procces_station_2", vector3(-100.34, 6202.42, 31.03), 1, 1.8, {
...
Citizen.CreateThread(function()
    exports["np-polyzone"]:AddBoxZone("dreams_chicken_process_1", vector3(-99.97, 6211.17, 31.03), 2, 2, {
...
AddEventHandler('np-polyzone:enter', function(name)
    if name == "dreams_chicken_process_1" then
		...
		exports['np-ui']:showInteraction("[E] Process Slaughtered Chicken [Bay 1]")
    end
end)
...
Citizen.CreateThread(function()
    exports["np-polyzone"]:AddBoxZone("dreams_chicken_process_2", vector3(-102.1, 6208.91, 31.03), 2, 2, {
...
AddEventHandler('np-polyzone:enter', function(name)
    if name == "dreams_chicken_process_2" then
		...
		exports['np-ui']:showInteraction("[E] Process Slaughtered Chicken [Bay 2]")
    end
end)
...
Citizen.CreateThread(function()
    exports["np-polyzone"]:AddBoxZone("dreams_chicken_process_3", vector3(-104.31, 6206.7, 31.03), 2, 2, {
...
AddEventHandler('np-polyzone:enter', function(name)
    if name == "dreams_chicken_process_3" then
		...
		exports['np-ui']:showInteraction("[E] Process Slaughtered Chicken [Bay 3]")
    end
end)
...
Citizen.CreateThread(function()
    exports["np-polyzone"]:AddBoxZone("dreams_chickens_start", vector3(2387.34, 5044.39, 46.31), 2, 2, {
...
AddEventHandler('np-polyzone:enter', function(name)
    if name == "dreams_chickens_start" then
		...
		exports['np-ui']:showInteraction("[E] Start Catching Chickens")
    end
end)
...
Citizen.CreateThread(function()
    exports["np-polyzone"]:AddBoxZone("dreams_chicken_sales", vector3(-591.81, -892.58, 25.81), 2, 2, {
...
AddEventHandler('np-polyzone:enter', function(name)
    if name == "dreams_chicken_sales" then
		...
		exports['np-ui']:showInteraction("[E] Sell Packaged Chickens")
    end
end)
