...
AddEventHandler('police:panic', function()
    ...
    TriggerServerEvent("InteractSound_SV:PlayWithinDistance", 3.0, 'polalert', 0.3)
      ...
      recipientList = {
		...
		TriggerEvent('np-alerts:policepanic')
end)
...
AddEventHandler("police:1047", function()
    ...
    recipientList = {
      police = "police", ems = "ems"
		...
		TriggerEvent('np-alerts:downguy')
end)
...
function AlertGunShot()
    Citizen.CreateThread(function() 
      ...
      TriggerEvent('np-alerts:gunshot')
...
function AlertpersonRobbed(vehicle)
  ...
  TriggerEvent('np-alerts:robstore')
...
function AlertCheckRobbery2()
  ...
  TriggerEvent('np-alerts:robhouse')
  Wait(math.random(5000,15000))
...
function DrugSales()
  ...
  TriggerEvent('np-alerts:sellingdrugs')
  Wait(math.random(5000,15000))
...
RegisterNetEvent("np-dispatch:alert", function(pType)
...
function AlertFleecaRobbery()
  ...
  TriggerEvent("np-dispatch:fleeca:bank", plyPos)
end
...
exports("SendAlert", function(pAlertType)
  TriggerEvent("np-dispatch:alert", pAlertType)
end)


RegisterCommand("2", function(src, args, raw)
  exports['np-dispatch']:SendAlert("AlertFleecaRobbery")
end)