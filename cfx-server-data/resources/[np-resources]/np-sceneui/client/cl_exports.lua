...
RegisterNetEvent("np-sceneui:open-application")
AddEventHandler("np-sceneui:open-application", openApplication)
...
function closeApplication(app, data)
  ...
  TriggerEvent("np-sceneui:application-closed", app, { fromEscape = false })
end
