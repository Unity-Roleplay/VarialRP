...
-- 	exports["np-polyzone"]:AddBoxZone("tuner", vector3(933.31, -971.0, 39.54), 30, 15, {
--         name="tuner",
--         heading=275,
--       --  debugPoly=true,
--         minZ=36.59,
...
--     exports["np-polyzone"]:AddBoxZone("auto_exotics", vector3(542.17, -177.28, 54.49), 53.8, 25, {
--         name="auto_exotics",
--         heading=189,
--         --debugPoly=true,
--         minZ=53.29,
...
--     exports["np-polyzone"]:AddBoxZone("harmony_autos", vector3(1178.51, 2640.06, 37.75), 13.8, 10, {
--         name="harmony_autos",
--         heading=270,
--         --debugPoly=true,
--         minZ=36.75,
...
--     exports["np-polyzone"]:AddBoxZone("hayes_autos", vector3(-1419.51, -447.71, 35.91), 26.6, 10, {
--         name="hayes_autos",
--         heading=302,
--         --debugPoly=true,
--         minZ=34.91,
