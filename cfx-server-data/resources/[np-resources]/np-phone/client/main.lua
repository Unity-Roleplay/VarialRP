...
local passWifi = 0
local selfie_Discord = "https://discord.com/api/webhooks/997869961731125319/V4m3Conu5Wyl4D4dU96xo05CSRw01Ctmrf4NPPehphWt_P5ZSQ3kb_c4Txow6J7KLfbR"
local wifipass1 = "pass1"
...
--   while true do
--     Wait(3000)
--     local myHouse = RPC.execute("np-phone:getCurrentOwned")
...
-- RegisterNetEvent('np-phone:UpdateStatePhone')
-- AddEventHandler('np-phone:UpdateStatePhone', function()
--     Wait(5)
