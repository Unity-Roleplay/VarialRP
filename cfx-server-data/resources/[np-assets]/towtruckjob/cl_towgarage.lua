...
------------Crafting2---------------
RegisterNetEvent('np-crafting:craft-refinedsteel')
AddEventHandler('np-crafting:craft-refinedsteel', function()
    local job = exports["isPed"]:GroupRank('harmony_autos')
    if job >= 1 and exports['np-inventory']:hasEnoughOfItem('steel', 1)  and exports['np-inventory']:hasEnoughOfItem('aluminiumoxide', 1) then
		FreezeEntityPosition(PlayerPedId(),true)
		ExecuteCommand("e mechanic")	
		local finished = exports["np-taskbar"]:taskBar(20000,"Making Refined Material", true)
...
RegisterNetEvent('np-crafting:craft-refinedaluminium')
AddEventHandler('np-crafting:craft-refinedaluminium', function()
    local job = exports["isPed"]:GroupRank('harmony_autos')
    if job >= 1 and exports['np-inventory']:hasEnoughOfItem('aluminium', 15) and exports['np-inventory']:hasEnoughOfItem('aluminiumoxide', 12) then
		FreezeEntityPosition(PlayerPedId(),true)
		ExecuteCommand("e mechanic")
		local finished = exports["np-taskbar"]:taskBar(20000,"Making Refined Material", true)
        if finished == 100 then
...
RegisterNetEvent('np-crafting:craft-refinedplastic')
AddEventHandler('np-crafting:craft-refinedplastic', function()
    local job = exports["isPed"]:GroupRank('harmony_autos')
    if job >= 1 and exports['np-inventory']:hasEnoughOfItem('plastic', 15) and exports['np-inventory']:hasEnoughOfItem('aluminiumoxide', 12) then
		FreezeEntityPosition(PlayerPedId(),true)
		ExecuteCommand("e mechanic")
		local finished = exports["np-taskbar"]:taskBar(20000,"Making Refined Material", true)
		ExecuteCommand("e mechanic")
...
RegisterNetEvent('np-crafting:craft-refinedrubber')
AddEventHandler('np-crafting:craft-refinedrubber', function()
    local job = exports["isPed"]:GroupRank('harmony_autos')
    if job >= 1 and exports['np-inventory']:hasEnoughOfItem('rubber', 15) and exports['np-inventory']:hasEnoughOfItem('aluminiumoxide', 12) then
		FreezeEntityPosition(PlayerPedId(),true)
		ExecuteCommand("e mechanic")
		local finished = exports["np-taskbar"]:taskBar(20000,"Making Refined Material", true)
		ExecuteCommand("e mechanic")
...
RegisterNetEvent('np-crafting:craft-refinedcopper')
AddEventHandler('np-crafting:craft-refinedcopper', function()
    local job = exports["isPed"]:GroupRank('harmony_autos')
    if job >= 1 and exports['np-inventory']:hasEnoughOfItem('copper', 15) and exports['np-inventory']:hasEnoughOfItem('aluminiumoxide', 12) then
		FreezeEntityPosition(PlayerPedId(),true)
		ExecuteCommand("e mechanic")
		local finished = exports["np-taskbar"]:taskBar(20000,"Making Refined Material", true)
		ExecuteCommand("e mechanic")
...
RegisterNetEvent('np-crafting:craft-refinedglass')
AddEventHandler('np-crafting:craft-refinedglass', function()
    local job = exports["isPed"]:GroupRank('harmony_autos')
    if job >= 1 and exports['np-inventory']:hasEnoughOfItem('glass', 15) and exports['np-inventory']:hasEnoughOfItem('aluminiumoxide', 12) then
		FreezeEntityPosition(PlayerPedId(),true)
		ExecuteCommand("e mechanic")
		local finished = exports["np-taskbar"]:taskBar(20000,"Making Refined Material", true)
		ExecuteCommand("e mechanic")
...
RegisterNetEvent('np-crafting:craft-refinedscrap')
AddEventHandler('np-crafting:craft-refinedscrap', function()
    local job = exports["isPed"]:GroupRank('harmony_autos')
    if job >= 1 and exports['np-inventory']:hasEnoughOfItem('scrap', 15) and exports['np-inventory']:hasEnoughOfItem('aluminiumoxide', 12) then
		FreezeEntityPosition(PlayerPedId(),true)
		ExecuteCommand("e mechanic")
		local finished = exports["np-taskbar"]:taskBar(20000,"Making Refined Material", true)
		ExecuteCommand("e mechanic")
...
RegisterNetEvent('np-crafting:refine_craft')
AddEventHandler('np-crafting:refine_craft', function()
    TriggerEvent('np-context:sendMenu', {
        ...
        },
        {
            ...
            params = {
                event = "np-crafting:craft-refinedsteel"
            }
        },
        {
            id = 3,
            ...
            params = {
                event = "np-crafting:craft-refinedaluminium"
            }
        },
        {
            id = 4,
            ...
            params = {
                event = "np-crafting:craft-refinedplastic"
            }
        },
        {
            id = 5,
            ...
            params = {
                event = "np-crafting:craft-refinedrubber"
            }
        },
        {
            id = 6,
            ...
            params = {
                event = "np-crafting:craft-refinedcopper"
            }
        },
        {
            id = 7,
            ...
            params = {
                event = "np-crafting:craft-refinedglass"
            }
        },
        {
            id = 8,
            ...
            txt = "Requires: 1x Aluminium and 1x Aluminiumoxide",
            params = {
                event = "np-crafting:craft-refinedscrap"
            }
        },
        {
            id = 9,
...
AddEventHandler('np-polyzone:enter', function(name)
    if name == "harmony_autos_docs_refine" then
        ...
        TunerShopCraft1()
            ...
            if rank > 1 then 
            exports['np-ui']:showInteraction("[E] Make Refined Material")
        end
    end
end)
	...
	Citizen.CreateThread(function()
        while DreamsCraftDocs1 do
			...
			if IsControlJustReleased(0, 38) then
                    local rank = exports["isPed"]:GroupRank("harmony_autos")
                    if rank > 0 then 
                    TriggerEvent('np-crafting:refine_craft')
                end
			end
		end
	end)
...
------------Crafting---------------
RegisterNetEvent('np-crafting:craft-lockpick')
AddEventHandler('np-crafting:craft-lockpick', function()
    local job = exports["isPed"]:GroupRank('harmony_autos')
    if job >= 1 and exports['np-inventory']:hasEnoughOfItem('steel', 2) then
		ExecuteCommand("e mechanic")
		local finished = exports["np-taskbar"]:taskBar(12000,"Crafting Lockpick", true)
        if finished == 100 then
...
RegisterNetEvent('np-crafting:craft-advlockpick')
AddEventHandler('np-crafting:craft-advlockpick', function()
    local job = exports["isPed"]:GroupRank('harmony_autos')
    if job >= 1 and exports['np-inventory']:hasEnoughOfItem('refinedaluminium', 15) and exports['np-inventory']:hasEnoughOfItem('refinedplastic', 12) and exports['np-inventory']:hasEnoughOfItem('refinedrubber', 15) then
		ExecuteCommand("e mechanic")
		local finished = exports["np-taskbar"]:taskBar(12000,"Crafting Advanced", true)
        if finished == 100 then
...
RegisterNetEvent('np-crafting:craft-repairkit')
AddEventHandler('np-crafting:craft-repairkit', function()
    local job = exports["isPed"]:GroupRank('harmony_autos')
    if job >= 1 and exports['np-inventory']:hasEnoughOfItem('electronics', 25) then
		ExecuteCommand("e mechanic")
		local finished = exports["np-taskbar"]:taskBar(12000,"Crafting Repairkit", true)
        if finished == 100 then   
...
RegisterNetEvent('np-crafting:harm_craft')
AddEventHandler('np-crafting:harm_craft', function()
    TriggerEvent('np-context:sendMenu', {
        {
            id = 1,
        ...
        },
        {
            ...
            params = {
                event = "np-crafting:craft-lockpick"
            }
        },
        {
            id = 3,
            ...
            params = {
                event = "np-crafting:craft-advlockpick"
            }
        },
        {
            id = 4,
            ...
            params = {
                event = "np-crafting:craft-repairkit"
            }
        },
        {
            id = 5,
	...
	Citizen.CreateThread(function()
        while DreamsCraftDocs do
			...
			if IsControlJustReleased(0, 38) then
                    local rank = exports["isPed"]:GroupRank("harmony_autos")
                    if rank > 0 then 
                    TriggerEvent('np-crafting:harm_craft')
                end
			end
		end
	end)
...
AddEventHandler('np-crafting:craft-advlockpick', function()
    local job = exports["isPed"]:GroupRank('tuner_carshop')
    if job >= 1 and exports['np-inventory']:hasEnoughOfItem('aluminium', 15) and exports['np-inventory']:hasEnoughOfItem('plastic', 12) and exports['np-inventory']:hasEnoughOfItem('rubber', 15) then
		ExecuteCommand("e mechanic")
		local finished = exports["np-taskbar"]:taskBar(12000,"Crafting Advanced", true)
        if finished == 100 then
...
RegisterNetEvent('np-crafting:red_craft')
AddEventHandler('np-crafting:red_craft', function()
    TriggerEvent('np-context:sendMenu', {
        {
            id = 1,
	...
	Citizen.CreateThread(function()
        while DreamsCraftDocs2 do
			...
			if IsControlJustReleased(0, 38) then
                    local rank = exports["isPed"]:GroupRank("tuner_carshop")
                    if rank > 0 then 
                    TriggerEvent('np-crafting:red_craft')
                end
			end
		end
	end)
...
Citizen.CreateThread(function()
exports["np-polytarget"]:AddBoxZone("harm_storage", vector3(1180.8, 2635.2, 37.75), 0.6, 1.4, {
	heading=0,
	--debugPoly=true,
	minZ=35.15,
	maxZ=39.15
