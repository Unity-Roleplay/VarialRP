local DISCORD_WEBHOOK5 = "https://discord.com/api/webhooks/997810985417068545/sJ-XX-01GNUYLiDasC5EREQcFs2CJeXN1UN-2tzWXm2hG8_T00NgKKaAP-x9XiD1qXaT"
...
AddEventHandler('bank:givemecash', function(sender, reciever, amount)
  local user = exports["np-base"]:getModule("Player"):GetUser(sender)
...
AddEventHandler("bank:getLogs", function()
  local srcID = source
  local user = exports["np-base"]:getModule("Player"):GetUser(srcID)
  local char = user:getCurrentCharacter()
