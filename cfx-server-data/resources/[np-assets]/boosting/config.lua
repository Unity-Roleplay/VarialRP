...
Config['CoreSettings'] = {
    ["ESX"] = {
        ...
        ["ProgressBarScriptName"] = "np-taskbar", -- progress bar script name link in esx_readme.md
    },
    ["QBCORE"] = {
...
Config['Utils'] = {
    ...
    ["Contracts"] = {
        ["TimeBetweenContracts"] = 3000000, -- Time in (ms) between contract creations
        ["ContractChance"] = 60, -- This is the luck percentage of getting a contract
    },
    ["VIN"] = {
        ["BNEPrice"] = 200, -- Price (BNE) for start a vin scratch
        ["AmountBneAfterDropOff"] = 20, 
...
Config.Vehicles = {
    ...
    [41] = {vehicle = "Bison2"},
    [42] = {vehicle = "Minivan2"},
    [43] = {vehicle = "RatLoader"},
    [44] = {vehicle = "Virgo2"},
    ---------- D CLASS --------------
    [45] = {vehicle = "Dilettante"},
