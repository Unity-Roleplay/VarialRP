...
Citizen.CreateThread(function()
    ...
    exports["np-polyzone"]:AddBoxZone("sandy_clothing_lockers", vector3(1855.59, 3692.15, 34.22), 2.1, 2.9, {
        heading = 30,
        minZ = 31.42,
        maxZ = 35.42
    })

    exports["np-polyzone"]:AddBoxZone("sandy_character_switch_evidence_trash_armory", vector3(1862.08, 3690.21, 34.22),
        2.6, 3.8, {
            heading = 30,
            minZ = 32.02,
            maxZ = 36.02
    ...
    exports["np-polyzone"]:AddBoxZone("paleto_clothing_lockers_character_switch_evidence_trash_armory",
    ...
    exports["np-polyzone"]:AddBoxZone("paleto_clothing_lockers_character_switch", vector3(-438.57, 6010.16, 37.0), 4.8,
        3.6, {
            heading = 316,
            minZ = 35.8,
            maxZ = 38.4
    ...
    exports["np-polyzone"]:AddBoxZone("beaverpd_clothing_lockers_character_switch_evidence_trash_armory",
    ...
    exports["np-polyzone"]:AddBoxZone("pd_shared", vector3(1847.74, 3671.26, 33.87), 50.6, 7.8, {
        heading = 300.0,
        minZ = 32.27,
        maxZ = 36.07
    })
    ...
    -- Sandy PD
    exports["np-polyzone"]:AddBoxZone("pd_shared", vector3(1843.4, 3636.82, 35.64), 11.2, 10.0, {
        heading = 355,
        minZ = 34.24,
        maxZ = 39.44
    })
    ...
    exports["np-polyzone"]:AddBoxZone("pd_shared_bike", vector3(1880.59, 3691.18, 33.54), 6.4, 7.0, {
        heading = 30,
        minZ = 32.14,
        maxZ = 35.94
    })
    ...
    exports["np-polyzone"]:AddBoxZone("ems_shared", vector3(1814.22, 3686.16, 34.22), 9.2, 5.2, {
        name = "ems_sandy",
        heading = 299,
        minZ = 32.62,
        maxZ = 36.62
    ...
    exports["np-polyzone"]:AddCircleZone("ems_shared", vector3(1865.39, 3647.48, 35.6), 9.75, {
        name = "ems_sandy_heli"
    })
